...
//   // ==========================================================
//   // === YEH RAHA SAHI DOWNLOAD FUNCTION (COMPONENT KE ANDAR) ===
//   // ==========================================================
...
//         {application && application.status === "Pending Fee" && (
//           <div
//             className="bg-orange-100 border-l-4 border-orange-500 text-orange-800 p-6 rounded-lg shadow-md mb-8"
//             role="alert"
//           >
//             <div className="flex items-center">
//               <FaShieldAlt className="w-8 h-8 mr-4" />
//               <div>
//                 <p className="font-bold text-xl">
//                   Action Required: Pay Registration Fee
//                 </p>
//                 <p className="mt-1">
//                   Your application is submitted. Please pay the fee to start the
//                   review process.
//                 </p>
//               </div>
//             </div>
//             <Link to={`/pay-registration-fee/${application._id}`}>
//               <button className="mt-4 bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-5 rounded-md shadow">
//                 Pay Fee Now
//               </button>
//             </Link>
//           </div>
...
//                       <div
//                         className="bg-yellow-500 h-6 animate-pulse"
//                         style={{ width: "60%" }}
//                       ></div>
//                     </div>
...
//                     Your KYC is verified. You can now apply for a loan.
//                   </p>
//                   <Link
//                     to="/apply-loan"
...
function StylishDashboard() {
  ...
  useEffect(() => {
    ...
    socket.on("status_updated", (update) => {
      setApplication((prevApp) => {
        if (prevApp && prevApp._id === update.id) {
          fetchDashboardData();
          return { ...prevApp, status: update.status };
        }
        return prevApp;
      });
    });
  ...
  // ==========================================================
  // === YEH RAHA AAPKA SAHI handlePayment FUNCTION ===
  // ==========================================================
  const handlePayment = async (emi) => {
    if (!application) return;
          ...
          >
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="mt-1">
                  Please pay the fee to start the review process.
                </p>
              </div>
            </div>
            <Link to={`/pay-registration-fee/${application._id}`}>
